...
class nnUNetTrainerV2_Loss_Dice(nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.loss = SoftDiceLoss(**{'apply_nonlin': sigmoid_helper, 'batch_dice': self.batch_dice, 'smooth': 1e-5, 'do_bg': False})
...
class nnUNetTrainerV2_Loss_DicewithBG(nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.loss = SoftDiceLoss(**{'apply_nonlin': sigmoid_helper, 'batch_dice': self.batch_dice, 'smooth': 1e-5, 'do_bg': True})
